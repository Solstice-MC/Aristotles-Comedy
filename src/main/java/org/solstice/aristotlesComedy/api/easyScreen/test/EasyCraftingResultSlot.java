...
import org.solstice.aristotlesComedy.api.easyScreen.slot.EasySlot;

public class EasyCraftingResultSlot extends EasySlot {

	private final RecipeInputInventory input;
//	private final PlayerEntity player;
//	private int amount;

	public EasyCraftingResultSlot(PlayerEntity player, RecipeInputInventory input, Inventory inventory, int index, int x, int y) {
