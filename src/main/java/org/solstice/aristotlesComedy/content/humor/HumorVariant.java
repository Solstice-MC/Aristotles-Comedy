...
public record HumorVariant (
	...
	public static final Codec<HumorVariant> CODEC = RecordCodecBuilder.create(instance -> instance.group(
		AristotlesRegistries.HUMOR.getEntryCodec().fieldOf("humor").forGetter(HumorVariant::getRegistryEntry),
	...
	public static HumorVariant blank() {
		return of(AristotlesHumors.EMPTY);
	}
	...
	public boolean isBlank() {
		return this.humor == AristotlesHumors.EMPTY;
	}
	...
	public RegistryEntry<Humor> getRegistryEntry() {
		return AristotlesRegistries.HUMOR.getEntry(this.humor);
	}
