...
public abstract class AbstractAshBunnyEntity extends PassiveEntity implements HoppingEntity {
	...
	public void poof() {
		...
		world.playSound(this, this.getBlockPos(), AristotlesSoundEvents.ENTITY_ASH_BUNNY_POOF, SoundCategory.NEUTRAL, 1, 1);
		this.placeAshLayer();
	}
	...
	public void placeAshLayer() {
		...
		if (!state.isOf(AristotlesBlocks.ASH)) {
			state = AristotlesBlocks.ASH.getDefaultState();
		} else {
